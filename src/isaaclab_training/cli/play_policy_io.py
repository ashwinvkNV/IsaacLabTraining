...
_DEFAULT_TASK = "IsaacTraining-DisplayPortInsertion-Rizon4s-Joint-NoJointVel-ROS-Inference"
...
class LeappDisplayportPolicy:
    ...
    def __init__(self, env, leapp_yaml: Path, clip_actions: float | None = None):
        try:
            ...
            raise ImportError(
                "LEAPP is required for --leapp_model. Install this repo with: uv sync --group leapp"
            ) from exc
